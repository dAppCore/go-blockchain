...
func TestTransactionV2_V2CoinbaseRoundTrip_Good(t *testing.T) {
...
func TestTransactionV2_V2CoinbaseTxHash_Good(t *testing.T) {
...
func TestTransactionV2_V2CoinbaseFields_Good(t *testing.T) {
	blob, _ := hex.DecodeString(testnetCoinbaseV2Hex)
	dec := NewDecoder(bytes.NewReader(blob))
	tx := DecodeTransaction(dec)
	if dec.Err() != nil {
...
func TestTransactionV2_V2PrefixDecode_Good(t *testing.T) {
	blob, _ := hex.DecodeString(testnetCoinbaseV2Hex)
	dec := NewDecoder(bytes.NewReader(blob))
